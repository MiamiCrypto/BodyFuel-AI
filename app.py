...
if st.button("Generate Meal Plan"):
    ...
    if meal_type == "All":
        ...
        max_tokens = 150 * 3  # 220 tokens per recipe, 3 recipes
    else:
        prompt = (
        ...
        max_tokens = 220 * 2  # 240 tokens per recipe, 2 recipes  # 250 tokens per recipe, 2 recipes  # 260 tokens per recipe, 2 recipes
