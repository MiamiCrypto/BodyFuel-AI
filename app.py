...
if st.button("Generate Meal Plan"):
    ...
    if meal_type == "All":
        ...
        max_tokens = 160 * 3  # 220 tokens per recipe, 3 recipes
    else:
        prompt = (
        ...
        max_tokens = 240 * 2  # 240 tokens per recipe, 2 recipes  # 250 tokens per recipe, 2 recipes  # 260 tokens per recipe, 2 recipes
